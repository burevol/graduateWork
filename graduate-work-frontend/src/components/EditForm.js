...
function EditForm() {
    ...
    function deleteFile() {
        ...
        const url = `http://localhost:8000/api/video/${params.id}`
            ...
            <div className="container max-w-sm px-4">
                ...
                <div className="flex">
                    ...
                    <button type="button" onClick={deleteFile}
                            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 mt-10 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Удалить
                    </button>
                </div>
            </div>
        </div>
